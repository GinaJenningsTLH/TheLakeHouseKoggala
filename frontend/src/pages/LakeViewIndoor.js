...
const LakeViewIndoor = () => {
    const images = [
        { src: '../assets/images/room1.jpg', alt: 'Room 1' },
        { src: '/assets/images/room2.jpg', alt: 'Room 2' },
        { src: '/assets/images/room3.jpg', alt: 'Room 3' },
        { src: '/assets/images/room4.jpg', alt: 'Room 4' },
    ];
