...
import { faBed, faShower, faWifi, faSnowflake, faGlassMartini, faConciergeBell, faFan, faSpa, faTableTennis, faCocktail, faUtensils, faSwimmer } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="container mx-auto py-16 px-4">
        ...
        <div className="flex flex-col items-center mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            <div className='border border-gray-300 shadow-lg rounded-lg'>
              <h2 className="px-4 py-3 text-2xl font-bold text-[#5F9540] leading-10 bg-gray-200 rounded-t-lg">Lake View Room (Outdoor Shower)</h2>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
              <LazyLoadImage src={relatedRoom2} alt="Garden View Indoor" effect="blur" className="w-full h-48 object-cover" />
              <div className="p-6">
